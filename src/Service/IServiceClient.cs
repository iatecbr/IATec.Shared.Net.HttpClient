...
namespace IATec.Shared.HttpClient.Service
{
    ...
    public interface IServiceClient
    {
        ...
        Task<ResponseDto<string>> GetStringAsync<TError>(string url);
        ...
        Task<ResponseDto<T>> PostAsync<T,TError>(string url, HttpContent content) where T : class;
        ...
        Task<ResponseDto<T>> PutAsync<T,TError>(string url, HttpContent content) where T : class;

        Task<BaseResponseDto> DeleteAsync(string url);        
        Task<ResponseDto<T>> DeleteAsync<T>(string url) where T : class;
        Task<ResponseDto<T>> DeleteAsync<T,TError>(string url) where T : class;
    }    
}